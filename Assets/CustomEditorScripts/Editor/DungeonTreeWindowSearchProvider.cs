...
namespace DungeonTree
{
    ...
    public class DungeonTreeWindowSearchProvider : ScriptableObject, ISearchWindowProvider
    {


        public DungeonTreeView graph;
        ...
        public bool OnSelectEntry(SearchTreeEntry SearchTreeEntry, SearchWindowContext context)
        {
            ...
            DungeonTreeNode node = (DungeonTreeNode)element.target;
